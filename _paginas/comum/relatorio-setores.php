        ...
        <div class="col s12">
            ...
            <div id="impressao">
                ...
                <table class="striped">
                    <thead>
                        ...
                        <tr class="font_tabela_cab">
                            ...
                            <th style="width: 12%">Nº DE PATRIMÔNIO</th>
                            <th style="width: 8%">SIT. FÍSICA</th>
                        </tr>
                ...
                <?php include_once '../../banco_de_dados/comum/read-itens-setores.php' ?>
                    ...
                    <tr>
                        <td colspan="5"><p class="center-align font_tabela_cab">Obs.: Cabe aos funcionários deste setor a responsabilidade dos bens móveis citado acima.</p></td>
                    </tr>
            </table>
                <div class="col s4">
                ...
                <div class="col s4">
                    <p style="text-decoration: overline; margin-top: 50px;">Responsável pela Conferência/COMAP</p>
                </div>
                <div class="col s4">
