...
while ($registros = $querySelect->fetch_assoc()){
    ...
    if ($situacao == "I") {
        ...
        echo "<td>$nome</td><td>$matricula</td><td>$email</td><td>$login</td><td>$telefone</td><td>$permissao</td><td>$situacao</td><td>$log</td>";
        echo "<td><a href='editar-usuario.php?id=$id'><i class='material-icons'>edit</i></a></td>";
        echo "<td><a href='banco_de_dados/modifica_situacao_user.php?id=$id&sit=$situacao&id_anterior=$id_unidade'><i class='material-icons' style='color:red'>do_not_disturb_on</i></a></td>";
        echo "</tr>";
    } else {
        echo "<tr id='destaque'>";
        echo "<td>$nome</td><td>$matricula</td><td>$email</td><td>$login</td><td>$telefone</td><td>$permissao</td><td>$situacao</td><td>$log</td>";
        echo "<td><a href='editar-usuario.php?id=$id'><i class='material-icons'>edit</i></a></td>";
        echo "<td><a href='banco_de_dados/modifica_situacao_user.php?id=$id&sit=$situacao&id_anterior=$id_unidade'><i class='material-icons' style='color:green'>lens</i></a></td>";
        echo "</tr>";
    }
