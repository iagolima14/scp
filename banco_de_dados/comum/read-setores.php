...
while ($registros = $querySelect->fetch_assoc()){
    ...
    if ($situacao == "I") {
        ...
        echo "<td>$nome</td><td class='center-align'><a href=''>$num_linhas</a></td><td>$responsavel</td><td>$telefone</td>";
        ...
        echo "<td>$nome</td><td class='center-align'><a href=''></a>$num_linhas</td><td>$responsavel</td><td>$telefone</td>";
        echo "<td><a href='editar-setor.php?id=$id'><i class='material-icons'>edit</i></a></td>";
