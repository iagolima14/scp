...
while ($registros1 = $querySelect1->fetch_assoc()){
    ...
    if ($situacao == "I") {
        ...
        echo "<td>$nome</td><td>$matricula</td><td>$email</td><td>$login</td><td>$telefone</td><td>$nome_unidade</td><td>$permissao</td>";
        echo "<td><a href='editar-usuario.php?id=$id&op_filtro_anterior=$id_unidade'><i class='material-icons'>edit</i></a></td>";
