<?php
    ...
    $querySelect = $link->query("select it.nome_item, il.id_item, il.id_lancamento, il.quantidade, il.valor from tb_itens_lancamento as il INNER JOIN tb_itens as it ON il.id_item = it.id where il.id_lancamento = '$ultimo_id'");
    $i = 0;
