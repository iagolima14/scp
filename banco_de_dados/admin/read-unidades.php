...
while ($registros = $querySelect->fetch_assoc()){
    ...
    echo "<td>$nome</td>
        ...
        <td><a href='editar-diretor.php?nome_diretor=$nome_user_diretor&id_user_diretor=$id_usuario_diretor&id_unidade_selecionada=$id'><i class='material-icons'>sync</i></a></td><td>$telefone</td>";
