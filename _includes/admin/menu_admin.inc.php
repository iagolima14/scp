...
<nav class="deep-orange">
    <div class="nav-wrapper container">
        ...
        <ul id="dropdown2" class="dropdown-content ">
            ...
            <li><a href="consultar-setor.php">Setores</a></li>
        </ul>
        <!-- GRUPO DE OPÇÕES DO NAV (CADASTROS) QUANDO DIMINUIR A TELA (MOBILE)-->
        <ul class="sidenav" id="mobile-demo">
            <li><a href="consultar-usuario.php">Usuários</a></li>
        ...
        <div class="nav-wrapper">
            <ul class="right hide-on-med-and-down">
                <!-- Dropdown Trigger -->
                <li><a class="dropdown-trigger" href="#" data-target="dropdown2"><i class="material-icons left">search</i>Consultas<i class="material-icons right">arrow_drop_down</i></a></li>
            </ul>
            <ul class="right hide-on-med-and-down">
                <!-- Dropdown Trigger -->
                <li><a class="dropdown-trigger" href="#" data-target="dropdown1"><i class="material-icons left">account_circle</i>Cadastros<i class="material-icons right">arrow_drop_down</i></a></li>
            </ul>
        </div>
    </div>
</nav>
